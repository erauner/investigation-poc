...
from .tools import _canonical_target, _scope_from_target, collect_node_context, collect_service_context, collect_workload_context
...
def build_root_cause_report(req: BuildRootCauseReportRequest) -> RootCauseReport:
    ...
    if scope == "node":
        ...
        service_name = req.service_name or target.split("/", 1)[1]
