...
- Treat this command as the generic shadow investigation path.
...
- Do not use this command as the primary alert entrypoint. Use `/investigate-alert-shadow` for alert triage.
